...
#4. graf
#uredi še labele zunaj diagrama
#tortni diagram

podatki3 <- prodaja.in.potrosnja %>% filter(leto == 2020)
ggplot(podatki3, aes(x="", y=razmerje, fill=pridelek)) +
...
#pie(podatki3$razmerje, labels = podatki3$pridelek)
...
#6. graf:
ggplot(samooskrba.in.poraba, aes(poraba, zivila)) + geom_boxplot(fill = "lightblue") + xlab("Poraba") + 
  ylab("Živila") + 
...
tm_shape(graf.zemljevid0) + tm_polygons("stevilo.zivine" , popup.vars = c("Število goveda: " = "stevilo.zivine"),
...
tm_shape(graf.zemljevid) + tm_polygons("stevilo.zivine" , popup.vars = c("Število goveda: " = "stevilo.zivine"),
                                       style = "pretty", palette="Blues",title="Število goveda") +
  tm_layout(
...
tm_shape(graf.zemljevid2) + tm_polygons("povrsina" , popup.vars = c("Število hektarjev gozdov " = "povrsina"),
...
tm_shape(graf.zemljevid3) + tm_polygons("povrsina" , popup.vars = c("Število hektarjev gozdov " = "povrsina"),
                                        style = "pretty", palette="Blues",
                                        title="Število hektarjev gozda") +
  tm_layout(
    "Število hektarjev gozdov v 2016",
    legend.title.size=1,
    legend.text.size = 0.8,
    legend.position = c("right","bottom"),
    legend.bg.color = "white",
